...
<html
  ...
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?php echo base_url();?>public/assets/admin/vendor/css/pages/page-auth.css" />
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                    <img alt="logo" class="login_img" src="<?php echo base_url();?>assets/admin/img/logo.png">
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-6" action="<?= site_url('login') ?>" method="post">
                <?= csrf_field() ?>
                <div class="mb-6">
